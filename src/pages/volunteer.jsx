    ...
    <PageContainer>
      ...
      <section id="who-were-looking-for">
        ...
        <p className="mb-20 text-xl text-neutral-500">
          ...
          skills and contribute to a supportive community are welcome! If you're
          enrolled in any of RRC Polytech's ACE programs, there's a place for
          you to contribute in the BBA.
        </p>
      </section>
      ...
      <section id="opportunities" className="mb-20">
        ...
        <div className="flex flex-col justify-center gap-8 lg:flex-row">
          <div className="flex flex-col items-center gap-4">
            <div className="grow rounded-lg border border-neutral-300 bg-neutral-50 p-5 text-base text-neutral-900 shadow-md lg:max-w-xs">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="grow rounded-lg border border-neutral-300 bg-neutral-50 p-5 text-base text-neutral-900 shadow-md lg:max-w-xs">
              ...
              <p>
                ...
                photography, video editing, or even podcast hosting, your unique
                talents can shine here. Contribute to our various social media
                accounts and newsletters to keep our community informed and
                engaged.
              </p>
            </div>
          </div>
      ...
      <section id="time-and-place" className="mb-20">
        ...
        <p className="text-xl text-neutral-500">
          ...
          Location details and times will be shared on our Discord server. Can't
          make it? No problem! Contribute your ideas via our open Discord
          server.
        </p>
      </section>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="grow rounded-lg border border-neutral-300 bg-neutral-50 p-5 text-base text-neutral-900 shadow-md lg:max-w-xs">
              ...
              <p>
                ...
                association; it's a community where your voice matters, and your
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="grow rounded-lg border border-neutral-300 bg-neutral-50 p-5 text-base text-neutral-900 shadow-md lg:max-w-xs">
              ...
              <p>
                ...
                experiences to enhance your skillset and boost your confidence.
              </p>
            </div>
          </div>
          <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:gap-10">
        <div className="relative mx-5 inline-block text-center text-4xl font-semibold before:absolute before:-inset-y-1 before:-inset-x-5 before:block before:-skew-y-3 before:bg-yellow-200/80 md:text-4xl">
